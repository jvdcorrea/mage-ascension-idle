...
check('Meditate has 6 upgrades', UPGRADES.filter(u => u.skillId === 'meditate').length === 6);
check('Meditate payoff starts at 1', payoffMult('meditate') === 1);
S.skills.meditate.lv = 5; S.res.knowledge = 50;
buyUpgrade('meditate-0');
check('Meditate upgrade doubles its payoff', S.upgrades['meditate-0'] === true && payoffMult('meditate') === 2);
S.skills.meditate.lv = 0;
